...
public class BuildNumberPreferenceController extends BasePreferenceController implements
    ...
    public boolean handlePreferenceTreeClick(Preference preference) {
        ...
        if (mDevHitCountdown > 0) {
            ...
            if (mDevHitCountdown == 0 && !mProcessingLastDevHit) {
                ...
                mDevHitToast = Toast.makeText(mContext,
                        mContext.getResources().getQuantityString(
                                R.plurals.show_dev_countdown_lessaosp, mDevHitCountdown,
                                mDevHitCountdown),
                        Toast.LENGTH_SHORT);
                mDevHitToast.show();
            }
            ...
            mDevHitToast = Toast.makeText(mContext, R.string.show_dev_already_lessaosp,
                    Toast.LENGTH_LONG);
            mDevHitToast.show();
            mMetricsFeatureProvider.action(
                    mMetricsFeatureProvider.getAttribution(mActivity),
    ...
    private void enableDevelopmentSettings() {
        ...
        mDevHitToast = Toast.makeText(mContext, R.string.show_dev_on_lessaosp,
                Toast.LENGTH_LONG);
        mDevHitToast.show();
    }
}
